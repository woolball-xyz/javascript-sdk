...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WoolballAiNetworkApi.SpeechRecognitionApi();
  });

  describe('(package)', function() {
    describe('SpeechRecognitionApi', function() {
      describe('speechToText', function() {
        it('should call speechToText successfully', function(done) {
          ...
          instance.speechToText(model, dtype, input, returnTimestamps, stream, chunkLengthS, strideLengthS, forceFullSequences, language, task, numFrames, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(WoolballAiNetworkApi.STTChunk);
            }
