...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranslationRequestContract', function() {
      beforeEach(function() {
        instance = new WoolballAiNetworkApi.TranslationRequestContract();
      });

      it('should create an instance of TranslationRequestContract', function() {
        // TODO: update the code to test TranslationRequestContract
        expect(instance).to.be.a(WoolballAiNetworkApi.TranslationRequestContract);
      });
      ...
      it('should have the property srcLang (base name: "srcLang")', function() {
        // TODO: update the code to test the property srcLang
        expect(instance).to.have.property('srcLang');
        // expect(instance.srcLang).to.be(expectedValueLiteral);
      });

      it('should have the property tgtLang (base name: "tgtLang")', function() {
        // TODO: update the code to test the property tgtLang
        expect(instance).to.have.property('tgtLang');
        // expect(instance.tgtLang).to.be(expectedValueLiteral);
      });
