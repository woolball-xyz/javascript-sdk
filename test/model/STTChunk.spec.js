...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('STTChunk', function() {
      beforeEach(function() {
        instance = new WoolballAiNetworkApi.STTChunk();
      });

      it('should create an instance of STTChunk', function() {
        // TODO: update the code to test STTChunk
        expect(instance).to.be.a(WoolballAiNetworkApi.STTChunk);
      });
      ...
      it('should have the property chunks (base name: "chunks")', function() {
        // TODO: update the code to test the property chunks
        expect(instance).to.have.property('chunks');
        // expect(instance.chunks).to.be(expectedValueLiteral);
      });
